...
MiniForge is a revolutionary AI-powered app creation platform that puts you in complete control. Instead of paying subscription fees to a middleman or being locked into one provider, you bring your own API keys from the AI platforms you already trust and use. Describe what you want to build, and MiniForge uses your chosen AI to generate fully functional, self-contained apps instantly.
...
- **Offline-first architecture** — Apps run locally on your Android device
...
**Getting API Keys:**
- **Claude**: Visit [console.anthropic.com/account/keys](https://console.anthropic.com/account/keys)
...
MiniForge works in 8 languages:
- 🇬🇧 English
- 🇪🇸 Español (Spanish)
- 🇫🇷 Français (French)
- 🇮🇱 עברית (Hebrew)
...
MiniForge automatically fetches available models from each provider's `/v1/models` API endpoint:
...
2. **Generation Phase**
   ...
   - What should it do: "Create a Pomodoro timer with 25-minute work sessions, 5-minute breaks, customizable durations, play a sound when time is up, and a clean interface with start/pause/reset buttons"
   - Tap **Generate**
...
1. **Be specific** in your descriptions
   - ❌ "Make a game"
   - ✅ "Create a simple matching game where users flip cards to find matching pairs, with 8 cards total and a score counter"
...
- **Can't access device hardware** (camera, microphone, sensors) — HTML apps have limited hardware access
- **Can't work offline** (generation requires internet and API calls)
- **Can't create games with complex graphics** (but simple 2D games work great)
...
MiniForge was created to give developers, creators, and dreamers the power to build their ideas without being locked into expensive platforms or giving up control of their data.

**Philosophy**: Simple, honest, user-first technology that respects your wallet, your privacy, and your independence.
